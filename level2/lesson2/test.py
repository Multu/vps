...
class DummyLinkedList2(unittest.TestCase):

    def setUp(self):
        self.linked_list2 = dummy.DummyLinkedList2()
        self.node1 = dummy.Node(1)
        self.node2 = dummy.Node(2)
        self.node3 = dummy.Node(3)
        self.node4 = dummy.Node(4)
        self.node5 = dummy.Node(5)
        self.node6 = dummy.Node(5)
        self.node7 = dummy.Node(3)
        self.node8 = dummy.Node(3)
    ...
    def test_remove_first_founded(self):
        ...
        self.linked_list2.delete(1)
        self.assertEqual(self.linked_list2.head.next, self.node2)
        self.assertEqual(self.linked_list2.tail.prev, self.node7)
        ...
        self.linked_list2.delete(5)
        self.assertEqual(self.linked_list2.head.value, None)
        self.assertEqual(self.linked_list2.tail.value, None)
    ...
    def test_add_in_head(self):
        ...
        self.linked_list2.add_in_head(self.node2)
        self.assertEqual(self.linked_list2.head.next, self.node2)
        self.assertEqual(self.linked_list2.head.next.next, self.node1)
        self.assertEqual(self.linked_list2.tail.prev, self.node1)
        self.assertEqual(self.linked_list2.tail.prev.prev, self.node2)
