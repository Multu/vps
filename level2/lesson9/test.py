...
class NativeDictionary(unittest.TestCase):
    ...
    def test_is_key(self):
        ...
        self.assertEqual(self.native_dict.is_key('three'), True)
    ...
    def test_get(self):
        ...
        self.assertEqual(self.native_dict.get('three'), 3)
